...
Nejprve jsou analyzovány možnosti modulu za účelem identifikace jeho provozních limitů.
Následně je navržena a sestavena vlastní dvouosá rotační platforma pro mechanické radaru, která umožňuje trojrozměrné prostorové skenování.
...
Přestože parametry použitého radarového modulu znemožňují sledování pohyblivých cílů, systém prokazuje funkčnost při monitorování různorodých statických prostředí -- od aplikací s vysokým rozlišením na krátkou vzdálenost až po detekci cílů na vzdálenost až 300 metrů.
Process zpracování dat je navržen s důrazem na flexibilitu, umožněnou vysokou mírou konfigurovatelnosti jeho jednotlivých částí.
}
