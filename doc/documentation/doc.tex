...
\begin{enumerate}
	\item Range-Azimuth map: Polar plot with range on the radius and azimuth on the angle.
	\item Range-Doppler map / Range-RCS map: Classical xy plot with range on x axis and doppler on y axis, if speed is not calculated the y axis is replaced with RCS value.
