...
In addition to picking ADC output there are many other necessary configurations that need to be set in order to get a meaningful data from the radar for this application.
