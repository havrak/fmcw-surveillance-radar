...
After the program has been sent it can be either started manually by sending a start command from the QUICK COMMAND box or by pressing the start button.
