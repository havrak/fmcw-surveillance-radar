...
Outline of the processing flow is shown in figure \ref{fig:feature_flow}.
This whole step is done in a separate thread, launched after latest chirp spectrum is buffered.
