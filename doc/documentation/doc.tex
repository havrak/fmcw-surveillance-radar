...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.6\textwidth]{../img/farfield3d.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.3\textwidth]{../img/sidar122.png}
  \caption[\sidar with 122~GHz header \cite{sidarPRO}]{\sidar with 122~GHz header \cite{sidarPRO}}
  \label{fig:sidar122}
\end{figure}
