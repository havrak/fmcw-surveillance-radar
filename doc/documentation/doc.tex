...
\begin{figure}[h!]
  ...
  \end{tikzpicture}
	...
	\caption[Ideal relation of frequency on time for received and sent signal \cite{adler2023}]{Ideal relation of frequency on time for received and sent signal \cite{adler202}}
