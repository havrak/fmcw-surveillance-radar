...
The resulting platform offers reliable, efficient operation tailored to radar needs, providing a practical, affordable alternative to existing commercial systems.
}
...
\def\ThesisTitleCS{Dvojosá rotační plaforma pro radarové systémy}
